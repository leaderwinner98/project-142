...
# API to return most popular articles using demographic filtering.
@app.route("/popular-articles")
def popular_articles():
    popular_articles = output()
    return jsonify(popular_articles)

# API to return top 10 similar articles using content-based filtering.
